...
//        assertEquals(74400,totalCost);
    ...
    @Test
    public void PleaseWork_INeedSleep_15() throws Exception {
        Party newParty = new Party (10,"meat","a","a");
        assertEquals(15, newParty.getFood("meat"));

    }
    @Test
    public void PleaseWork_INeedSleep2_15() throws Exception {
    ...
    @Test
    public void PleaseWork_INeedSleep3_15() throws Exception {
        Party newParty = new Party (10,"meat","beer","rock");
        newParty.getBeverages("beer");
